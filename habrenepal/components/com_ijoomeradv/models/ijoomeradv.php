...
class ijoomeradvModelijoomeradv extends JModel{
	...
	function loginProccess(){
		...
		$my = & CFactory::getUser(); //get current user 
	...
	function retriveToken() {
		...
		if(IJ_JOOMLA_VERSION===1.5){
			$token = JUtility::getHash(JUserHelper::genRandomPassword()); // Generate a new token
