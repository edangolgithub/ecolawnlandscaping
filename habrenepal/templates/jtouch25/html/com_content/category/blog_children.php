	...
	<?php foreach($this->children[$this->category->id] as $id => $child) : ?>
		...
		<li<?php echo $class; ?>>
			<?php $class = ''; ?>
				...
				<h3><a href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($child->id));?>"><?php echo $this->escape($child->title); ?>
				<?php if ( $this->params->get('show_cat_num_articles',1)) : ?>
					<span class="ui-li-count">(<?php echo $child->getNumItems(true); ?>)</span>
				<?php endif ; ?>
				</a></h3>
