	...
	_create: function () {
		...
		if ( o.headerText !== false || o.headerClose !== false ) {
			...
			if ( o.headerClose === true ) {
				$("<a class='ui-btn-left' rel='close'>Close</a>").appendTo(self.sdHeader).buttonMarkup({ theme  : o.themeHeader, icon   : 'delete', iconpos: 'notext', corners: true, shadow : true });
			}
