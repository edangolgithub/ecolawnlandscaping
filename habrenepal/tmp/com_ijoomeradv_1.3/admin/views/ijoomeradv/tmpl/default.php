				...
				<tr>
					<td>
						...
						<fieldset>
							...
							<ul>
								<li>Now, the iJoomer Advance is installed, you can download the Android app from <a href="https://play.google.com/store/apps/details?id=com.ijoomer.src" title="iJoomer Advance @ Google Play">Google Play here</a> and start testing.</li>
    							<li>Once you launch the app, you will be prompted to enter the URL of your website. Click Yes there and enter your Joomla URL. (If you are not getting this prompt, then KILL the application from Android and restart, it will ask again). It may happen that Facebook may not work there because of FB key settings etc.</li>
   	 							<li>Now on, the full app will talk with your VERY own server and you can test out the functionality.</li>
						...
						<fieldset>
							...
							<ul>
								<li>If you are an Android/iPhone Developer, you can simply download SDK which comes with Example Codes and design “As Seen On Demo App” and there on, start customizing the app as per your requirement.</li>
								<li>If you are a Consumer having no prior knowledge of Mobile Programming and want Professional help to Integrate theme and submit to Mobile Stores, you can buy iJoomer’s Consumer Plan get our assistance.</li>
						...
						<fieldset>
							...
							<ul>
								<li>iJoomer Advance integrates with several popular Joomla! Components. This can be achieved by using iJoomer Advance's extensions. All supported <a href="https://www.ijoomer.com/free-downloads.html" title="Other Supported Extensions">extensions are available here</a>.</li>
						...
						<fieldset>
							...
							<ul>
								<li>If you require any technical support just trail on to the forums at <a href="http://www.ijoomer.com/Forum/" title="iJoomer Advance Forum">http://www.ijoomer.com/Forum/</a></li>
						...
						<fieldset>
							...
							<ul>
								<li>If you have got any suggestions or feedback, please do share it with us at <a href="mailto:support@ijoomer.com" title="Mail Us">support@ijoomer.com</a></li>
