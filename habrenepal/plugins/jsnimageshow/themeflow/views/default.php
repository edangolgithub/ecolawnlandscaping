				...
				<div id="themeflow-navigation-tab" class="jsn-bootstrap">
					<div class="form-horizontal">
						<div class="row-fluid show-flow">
							<div class="span12">
								<div class="control-group">
									<label style="max-size: 150px" class="control-label hasTip" title="<?php echo JText::_('THEME_FLOW_ENABLE_KEYBOARD_ACTION_TITLE');?>::<?php echo JText::_('THEME_FLOW_ENABLE_KEYBOARD_ACTION_DESC'); ?>"><?php echo JText::_('THEME_FLOW_ENABLE_KEYBOARD_ACTION_TITLE');?></label>
									<div class="controls">
										<?php echo $lists['enableKeyboardAction']; ?>
									</div>
								</div>
								<div class="control-group">
									<label style="max-size: 150px" class="control-label hasTip" title="<?php echo JText::_('THEME_FLOW_ENABLE_MOUSEWHEEL_TITLE');?>::<?php echo JText::_('THEME_FLOW_ENABLE_MOUSEWHEEL_DESC'); ?>"><?php echo JText::_('THEME_FLOW_ENABLE_MOUSEWHEEL_TITLE');?></label>
									<div class="controls">
										<?php echo $lists['enableMouseWheelAction']; ?>
									</div>
								</div>
							</div>
						</div>
