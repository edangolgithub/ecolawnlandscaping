...
class plgJSNImageshowThemeCarousel extends JPlugin
{
	...
	function onLoadJSNShowcaseTheme($name, $themeID = 0)
	{
		...
		JHTML::script('jquery.event.drag-2.2.js', $this->_pathAssets.'js/jquery/');
		JHTML::script('jquery.event.drop-2.2.js', $this->_pathAssets.'js/jquery/');
		JHTML::script('jquery.roundabout.js', $this->_pathAssets.'js/jquery/');
		JHTML::script('jquery.roundabout-shapes.js', $this->_pathAssets.'js/jquery/');
		JHTML::script('jsn_is_carouseltheme_setting.js', $this->_pathAssets.'js/');
