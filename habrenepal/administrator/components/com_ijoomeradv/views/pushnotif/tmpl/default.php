...
<script type='text/javascript' src="<?php echo JURI::root()?>administrator/components/com_ijoomeradv/assets/js/jquery.autocomplete.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo JURI::root()?>administrator/components/com_ijoomeradv/assets/css/jquery.autocomplete.css" />
<script>
$().ready(function() {
	//$.noConflict();
				...
				<tr>
					...
					<td valign="top">
						<table class ="adminlist" width="100%">
							...
							<tfoot>
								<th>&nbsp;</th><th>&nbsp;</th><th>&nbsp;</td><th>&nbsp;</td><th>&nbsp;</th><th>&nbsp;</th>
							</tfoot>
						</table>
					</td>
				</tr>
