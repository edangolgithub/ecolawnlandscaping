	...
	<li><dl class="menu_type">
			...
			<dd><ul>
					<?php foreach ($list as $item): ?>
						<li class="menu-link">
							<input type="checkbox" <?php if($item->checked){echo 'checked="checked"';}?> id="<?php echo $item->itemid; ?>" value="<?php echo $item->itemid; ?>" name="menuitems[]" class="chkbox chk-menulink-2">
