    ...
    class TC_post_list_grid {
        ...
        */
        function tc_grid_prepare_single_post() {
		  ...
		  if ( in_category( array( 'portfolio', 'portfolio' ) )) {
			$habre_grid="effect-7";
			//} elseif ( in_category( array( 'News', 'समाचार' ) )) {
				//$habre_grid="effect-12";
			//} elseif ( in_category( array( 'voices' ) )) {
			//$habre_grid="effect-6";
			} else {
				$habre_grid="effect-3";
			}
			...
			if ( ! $this -> tc_grid_show_thumb() )
            	array_push( $_classes, 'no-thumb' , $habre_grid );
			elseif ( in_category( 'portfolio' ) )
            	array_push( $_classes, 'effect-7' );
	        else
