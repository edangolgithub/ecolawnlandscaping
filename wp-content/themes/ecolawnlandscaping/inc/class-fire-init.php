  ...
  class TC_init {
      ...
      function __construct () {
          ...
          $this -> content_404        = array(
            ...
            'text'              => __( "The page you are looking for is no longer here, or never existed in the first place (bummer). You can try searching for what you are looking for using the form below. If that still doesn't provide the results you are looking for, you can always start over from the home page." , 'customizr' )
          );
